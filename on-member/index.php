...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div id="home">
        ...
        <div id="slides" class="carousel slide" data-ride="carousel" data-interval="7000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active" style="background-image:url(../assets/img/bg1.jpeg);">
                ...
                <div class="carousel-item" style="background-image:url(../assets/img/bg3.jpeg);"></div>
                <div class="carousel-item" style="background-image:url(../assets/img/bg2.jpeg);"></div>
    ...
    <div class="row jumbotron welcome">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
            <p class="lead">online shop yang menyediakan berbagai macam Jam tangan.
