...
<body>
  ...
  <div class="jumbotron text-center">
    <img src="./assets/img/fotoProfil.jpeg" class="img-circle" width="250">
    <h1>
      <? $pecah['nama']; ?>
    </h1>
    <p class="text-danger">Siswa | SMKN 8 JEMBER | RPL</p>
    <h2 class="text-danger">Selamat Datang admin <?= $_SESSION['nama']; ?></h2>
  </div>
  <!-- akhir Jumbotron -->
  ...
  <section class="portfolio" id="portfolio">
    <div class="container">
      ...
      <div class="row">
        <?php $sql = $dbconnect->query('SELECT * FROM produk') ?>
        <?php while($row= $sql->fetch_assoc()): ?>
        <div class="col-sm-3">
          <a href="" class="thumbnail">
            <img src="../foto_produk/<?= $row['gambar_produk'] ?>" width="80">
          </a>
        </div>
      </div>
  <?php endwhile; ?>
  ...
  <footer>
    <div class="container text-center">
      <div class="row">
        <div class="col-sm-12">
          <p>&copy; Copyright 2018 | built with <i class="glyphicon glyphicon-apple"></i> by <a href="">Imamah</a></p>
        </div>
      </div>
